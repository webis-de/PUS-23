...
class TestRevision(unittest.TestCase):
    ...
    def test_reference_section_text(self):
        ...
        reference_section_of_revision1 = self.revision1.section_tree().find(strings=["references"], lower=True)[0]
        self.assertEqual(reference_section_text_of_revision1, reference_section_of_revision1.get_text())

    def test_section_tree_of_revision1(self):
        root_of_revision1 = self.revision1.section_tree()
    ...
    def test_section_tree_of_revision2(self):
        root_of_revision2 = self.revision2.section_tree()
